	...
	public static function engitech_render_menu_cart() {
		...
		<?php if ( ! $widget_cart_is_hidden ) : ?>
			<div class="octf-cart octf-cta-header">
				<a class="cart-contents ot-minicart" href="<?php echo $cart_url; ?>" title="<?php esc_attr_e( 'View your shopping cart', 'engitech' ); ?>"><i class="flaticon-shopper"></i> <span class="count"><?php echo $product_count; ?></span>
				</a>
